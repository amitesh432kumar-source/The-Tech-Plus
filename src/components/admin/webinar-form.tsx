    ...
    <form action={formAction} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1.5">
          ...
          <Input id="speakerName" name="speakerName" defaultValue={defaultValues?.speakerName} />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="speakerBio">Speaker bio</Label>
          <Input id="speakerBio" name="speakerBio" defaultValue={defaultValues?.speakerBio} />
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="scheduledTime">Time (display text)</Label>
          <Input id="scheduledTime" name="scheduledTime" placeholder="7:00 PM IST" defaultValue={defaultValues?.scheduledTime} required />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="durationMinutes">Duration (min)</Label>
          <Input id="durationMinutes" name="durationMinutes" type="number" min={0} defaultValue={defaultValues?.durationMinutes ?? 60} />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="maxSeats">Max seats</Label>
          <Input id="maxSeats" name="maxSeats" type="number" min={1} defaultValue={defaultValues?.maxSeats ?? 100} />
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        <Label htmlFor="meetingUrl">Meeting URL (Zoom/Meet)</Label>
      ...
      <SubmitButton className="w-auto">Save Webinar</SubmitButton>
    </form>
  );
}
